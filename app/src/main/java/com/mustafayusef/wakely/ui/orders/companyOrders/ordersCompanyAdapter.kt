...
class ordersCompanyAdapter(
    val context: Context,
    val response: List<com.mustafayusef.wakely.data.companyOrder.Data>
) : RecyclerView.Adapter<ordersCompanyAdapter.CustomViewHolder>(){
//
...
//        dt = c.time
        ...
        holder.view.priceOrderCard.text=data.price .toString()+" IQD"
       // holder.view.dayNum.
        holder.view.orderQuantity.text=data.totalQuantities .toString()
        holder.view.setOnClickListener {
            var bundel=Bundle()
            bundel.putSerializable("orderCompany",data)
            holder.view.findNavController().navigate(R.id.orderDetails,bundel)
