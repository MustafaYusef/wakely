...
import com.mustafayusef.wakely.data.nationalProduct.Data
...
class NationalProductsAdapter(
    val context: Context,
    val response: List<productData>
) : RecyclerView.Adapter<NationalProductsAdapter.CustomViewHolder>(){
//
